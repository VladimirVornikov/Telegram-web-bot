const { CHAIN, isTelegramUrl, toUserFriendlyAddress, UserRejectsError } =  require('@tonconnect/sdk');
const { bot } = require('./bot');
const { getWallets, getWalletInfo } =  require('./ton-connect/wallet');
const QRCode =  require('qrcode');
const { getConnector } =  require('./ton-connect/connector');
const { addTGReturnStrategy, buildUniversalKeyboard, pTimeout, pTimeoutException } =  require('./utils');
...
module.exports = {handleShowMyWalletCommand, handleConnectCommand, handleDisconnectCommand, handleSendTXCommand}