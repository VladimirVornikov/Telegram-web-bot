const { encodeTelegramUrlParameters, isTelegramUrl} = require('@tonconnect/sdk');
...
module.exports = {buildUniversalKeyboard, convertDeeplinkToUniversalLink,
    addTGReturnStrategy, pTimeout, pTimeoutException, AT_WALLET_APP_NAME} 